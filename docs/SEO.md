...
<meta
  ...
  content="Бесплатный онлайн бизнес-симулятор. Управляй компанией, конкурируй с ИИ, учись экономике."
/>
...
<meta
  ...
  content="Бесплатный онлайн бизнес-симулятор. Управляй компанией, конкурируй с ИИ."
/>
...
```json
{
  ...
  "itemListElement": [
    { "@type": "ListItem", "position": 1, "name": "Главная", "item": "https://bizsim.vercel.app/" },
    {
      ...
      "position": 2,
      "name": "Как играть",
      "item": "https://bizsim.vercel.app/how-to-play"
    }
  ]
}
```
